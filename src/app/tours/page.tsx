...
export default function tours() {
  return (
    <>
      ...
      <div
        id="Search"
        className="relative flex z-20  flex-col justify-center w-full h-[500px] items-center pt-32 gap-8"
      >
        ...
        <div className="relative grid grid-cols-3  w-[750px] z-20 h-[65px]  rounded-3xl  border-4 border-[#B2AC88] overflow-hidden">
          <PersonesMenu />
          <DateRangePicker
            className=" w-full"
